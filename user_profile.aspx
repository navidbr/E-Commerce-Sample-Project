<%@ Page Title="" Language="C#" MasterPageFile="~/Header_MasterPage.master" AutoEventWireup="true" CodeFile="user_profile.aspx.cs" Inherits="default_user_profile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <link rel="stylesheet" href="default/css/user_account_style.css" />
</asp:Content>
...
<%------------------------------------------------------------- پنل کوچک منو سمت راست ------------------------------------------------------------%>
		<div class="col-lg-3 col-md-4 col-sm-12 col-xs-12">
    	    <ul class="nav nav-pills nav-stacked well profile_font_Adobe_Arabic profile_border_radius">
              ...
              <li><a href="user_profile.aspx" runat="server" onserverclick="btn_favori_ServerClick"><i class="glyphicon glyphicon-send profile_glyphicon"></i> مورد علاقه ها</a></li>
